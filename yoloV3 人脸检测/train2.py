...
def train(data_config='cfg/face.data'):
    ...
    #     print('nimi')
    #     weights = './weights-yolov3-face-tiny5/'
    # else:
    #     model = Yolov3(num_classes)
    #     weights = './weights-yolov3-face-heat/'
    model = Yolov3(num_classes)
    weights = './weights-yolov3-face4e-10/'
    modelpath = '/root/cv/pycharm/人脸检测/yolo3-人脸检测/model-19/yolov3_last_416_epoch_19.pt'
    # 第二步：加载模型训练结果
    device = select_device()
    ...
    for epoch in range(0, epochs):
        ...
        for i, (imgs, taegets, img_path, _) in enumerate(dataloader):
            ...
            print(
                '  Epoch {:3d}/{:3d}, Batch {:6d}/{:6d}, Img_size {}x{}, nTargets {}, lr {:.25f}, loss: xy {:.3f}, wh {:.3f}, '
        ...
        torch.save(chkpt, weights + '/yolov3_19+{}_epoch_{}.pt'.format(img_size, epoch))
        # 创建第一张画布
        plt.figure(0)
